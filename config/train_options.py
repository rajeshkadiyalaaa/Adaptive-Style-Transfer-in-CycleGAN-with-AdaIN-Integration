...
class TrainOptions(BaseOptions):
    ...
    This class includes training-specific options such as learning rates,
    number of iterations, loss weights, etc.
    """
    ...
    def initialize(self, parser):
        ...
        # AdaIN training parameters
        parser.add_argument('--style_sample_method', type=str, default='random', help='how to sample style images [random | same_class]')
        parser.add_argument('--n_style_images', type=int, default=5, help='number of style images to use for training')
